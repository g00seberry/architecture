...
export class StrategyGenerateAdapters implements IStrategy<Promise<void>> {
  constructor(
    readonly genClassStrategy: IStrategyWithBind<AutoGeneratedClassDef>
  ) {}
        ...
        fNames.forEach((fName) => {
          try {
            ...
            const newClasses = extractedData.map((d) =>
              this.genClassStrategy.bind(d).execute()
            );
